...
Las conclusiones una vez finalizada la investigación son las siguientes.
Primero es que la cantidad de accidentes ha tenido una leve disminución con respecto al año 2013. A partir de ese año, los accidentes se mantienen en un rango similar hasta el 2020, año en que comenzó la pandemia. Como era de esperar, en dicho año, más precisamente en los meses de marzo, abril, mayo y junio, la cantidad de accidentes descendió notoriamente a causa de la poca circulación de la población. Lo principal a destacar es la baja en la cantidad de accidentes.
La segunda conclusión, es que en diciembre siempre aumentan los accidentes. Esto lo asociamos al comienzo de vacaciones y las fiestas de fin de año.
También se confirma que los autos y las motos son los vehículos con mayor participación de accidentes. Esto lo vinculamos con la composición del parque automotor del país.
Con respecto al análisis por departamento, vemos que Maldonado es el de mayor cantidad de accidentes cada 1000 habitantes. Como observamos anteriormente, en diciembre de cada año aumentan los accidentes debido a la mayor movilidad como consecuencia de las fiestas y las vacaciones. Maldonado es uno de los lugares más turísticos del país, por lo que recibe muchas personas. Concluimos que esa es una de las principales razones por la cual Maldonado es el departamento con mayor cantidad de accidentes cada 1000 habitantes.
Gracias a la comparación entre las variables sexo y rol de la persona accidentada hallamos que los conductores accidentados son mayoritariamente de sexo masculino.
Para finalizar, gracias a la comparación entre el vehículo y la gravedad del accidente, deducimos que los autos y las motos son los transportes que generan más fallecidos y que en los accidentes sin heridos, los autos son los que tienen mayor porcentaje. Podemos afirmar que el auto es más seguro que las motos.
