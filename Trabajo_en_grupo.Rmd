...
en los que se llegó al fallecimiento de alguna persona, o en general son heridas leves.
...
éste puede ser auto, bicicleta o moto, entre otros.
...
han sufrido menos?. Para esto se debería tener en cuenta a la población de cada uno de los departamentos,
por lo que resolvimos ver la cantidad de accidentes cada 1000 habitantes.
...
Del gráfico siguiente se observa que la gravedad de la lesión es mayor en las motos y en las bicicletas, la mayor proporción de personas que resultaron ilesas en un accidente de tránsito viajaba en auto.
