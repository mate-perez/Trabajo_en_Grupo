...
Este estudio se hará mediante la elaboración de gráficos y resúmenes sobre las variables relevantes que componen la base de información así como también el planteo de una applicacion web en shiny.

## Conjunto de datos

Esta análisis se va a basar en datos referentes a personas fallecidas en siniestros de tránsito en nuestro país, entre los años 2013 a 2019, extraidos del catalogo de datos de Uruguay (https://catalogodatos.gub.uy/dataset/unasev-fallecidos_siniestros_transito).
Juntamos los datos de cada año para asi poder hacer alguna pregunta temporal y ver si al pasar del tiempo hay algún cambio notorio.
...
###   * Correlacion entre el rol y el sexo??? 
