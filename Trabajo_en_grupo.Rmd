...
\begin{table}[hbpt]
	\centering
	\caption{Variables en \label{tab:VAR} \textbf{personas_13_21.RData}}
	\vspace{0.5cm}
	\begin{tabular}{|l|l|}
		\hline
...
```{r,fig.cap="Evolución temporal de la cantidad de fallecidos en accidentes de tránsito. Uruguay 2013-2021. Podemos apreciar que alrededor de marzo de 2020, momento en el cual empezó la pandemia, la cantidad de accidentes de tránsito tiene un gran descenso, debido probablemente a la disminución de movilidad antes mencionada."}
...
```{r, fig.cap="Evolución temporal de la cantidad de personas involucradas en accidentes de tránsito. Uruguay 2013-2021"}
...
```{r mapa, echo = FALSE,message=FALSE, results="asis", fig.cap= "Mapa con la cantidad de accidentes por departamento cada 1000 habitantes. Los departamentos con más accidentes son Montevideo y Canelones, con 915 y 686 accidentes respectivamente. Entre los dos departamentos, se acumula el 46 por ciento de accidentes del país. Análogamente, los departamentos con menos accidentes son Treinta y Tres con 44 accidentes, y Flores que acumula un total de 37." }
...
## ¿Qué tan graves o leves fueron los accidentes?, ¿Depende del vehículo en el que iba el accidentado?

```{r, fig.cap="Gráfico de barras apiladas al 100 por ciento del estado de salud de la persona involucrada en el accidente, separando por vehículo."}
personas_13_21 %>%
