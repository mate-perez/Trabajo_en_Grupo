...
\hline
X & Coordenada X del sitio donde ocurrio el siniestro \\
\hline
Y & Coordenada Y del sitio donde ocurrio el siniestro \\
\hline
\end{tabular}


En el Cuadro se presentan los metadatos con una breve describción de cada variable de el conjunto de datos.
...
```{r temporal, echo = FALSE, fig.cap= "Evolución temporal de la cantidad de accidentes. Se puede observar en el gráfico  que la cantidad de accidentes ha tenido una leve disminucion respecto al año 2013. A partir de ese año, los accidentes se mantienen un rango similar hasta el 2020." }
...
Otra apreciación interesante a partir del gráfico es una mejora en la completitud de las bases de datos con el paso de los años, ya que disminuye la cantidad de observaciones sin dato.
...
A partir de los datos de la cantidad de habitantes por departamento extraídos de https://otu.opp.gub.uy a partir del Censo de 2011 realizado por el Instituto Nacional de Estadística, y con la información georeferencia del lugar del accidente, se puede analizar la cantidad de accidentes por departamento cada 1000 habitantes en el período 2013-2021.

```{r mapa, echo = FALSE,message=FALSE, results="asis", fig.cap= "Distribución territorial la cantidad de accidentes cada 1000 habitantes en el período 2013-2021." }
...
## ¿Existe una relación entre el rol que cumplía la persona fallecida y el sexo de la misma? 
...
Del gráfico siguiente se observa que la gravedad de la lesión es mayor en las motos y en las bicicletas, la mayor proporción de personas que resultaron ilesas en un acccidente de tránsito viajaba en auto.

```{r, fig.cap="Distribución proporcional de la cantidad de personas accidentadas por tipo de vehículo según gravedad del accidente. Uruguay 2013-2021."}
personas_13_21 %>%
